...
(function(){
  ...
  if(heroActions){heroActions.innerHTML='<a class="secondary" href="#concerns">気になることから探す <span>›</span></a>';}
...
(function(){
  ...
  var localThreads=[];
  try{var saved=JSON.parse(localStorage.getItem('anotoki-community-v1')||localStorage.getItem('anotoki-community-v0')||'[]');if(Array.isArray(saved))localThreads=saved;}catch(e){}
  ...
  section.innerHTML='<div class="home-community-inner"><div class="home-community-head"><div><span class="home-community-kicker">みんなの声 / COMMUNITY</span><h2 id="home-community-title">みんなは、どう考えてる？</h2><p>延命、胃ろう、人工呼吸器、透析。正解を決める場所ではなく、違う考え方に出会う場所。</p></div><a class="home-community-more" href="community.html">Q&Aをもっと見る <span>→</span></a></div><div class="home-community-grid">'+previewThreads.map(function(t){return '<a class="home-community-card" href="community.html"><div class="home-community-tags"><span class="scene">'+esc(t.scene||'場面を限定しない')+'</span><span class="cat">'+esc(t.cat||'その他')+'</span><span class="kind">'+esc(t.kind||'投稿')+'</span></div><h3>'+esc(t.title)+'</h3><p>'+esc(t.body)+'</p><div class="home-community-meta"><span>'+esc(t.role||'匿名')+'</span><b>読む →</b></div></a>';}).join('')+'</div><div class="home-community-foot"><span>延命を希望する考えも、希望しない考えも、まだ分からないという考えも。</span><a href="community.html">みんなに聞いてみる →</a></div></div>';
  main.insertBefore(section,main.firstElementChild);
  var style=document.createElement('style');
  style.textContent='.home-community-preview{background:#f8f8f5;border-bottom:1px solid #e4e7e5;padding:42px 28px 38px}.home-community-inner{max-width:1280px;margin:0 auto}.home-community-head{display:flex;align-items:end;justify-content:space-between;gap:24px;margin-bottom:17px}.home-community-kicker{display:inline-flex;border-radius:999px;padding:5px 10px;background:#f0f4eb;border:1px solid #d5dfcd;color:#597046;font-size:8px;font-weight:900;letter-spacing:.08em}.home-community-head h2{font-family:"Yu Mincho","Hiragino Mincho ProN",serif;color:#203f54;font-size:clamp(24px,3vw,34px);line-height:1.45;margin:8px 0 5px;font-weight:700}.home-community-head p{font-size:11px;color:#68767c;margin:0}.home-community-more{display:inline-flex;align-items:center;gap:12px;border:1px solid #6e877c;border-radius:999px;background:#718d82;color:#fff;padding:10px 16px;font-size:10px;font-weight:900;white-space:nowrap;box-shadow:0 5px 12px rgba(55,79,71,.12)}.home-community-more:hover{background:#627c72;transform:translateY(-1px)}.home-community-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.home-community-card{display:block;background:#fff;border:1px solid #daddda;border-radius:16px;padding:16px 17px;box-shadow:0 3px 11px rgba(54,67,70,.05);transition:.18s}.home-community-card:hover{transform:translateY(-2px);box-shadow:0 9px 18px rgba(54,67,70,.09);border-color:#bcc7c3}.home-community-tags{display:flex;gap:6px;flex-wrap:wrap}.home-community-tags span{font-size:8px;font-weight:900;border-radius:999px;padding:3px 7px}.home-community-tags .scene{background:#f0f5f7;color:#456878;border:1px solid #d7e3e8}.home-community-tags .cat{background:#f1f4ed;color:#5a6c4d;border:1px solid #d9e0d2}.home-community-tags .kind{background:#f7f3ed;color:#74624c;border:1px solid #e6ddd1}.home-community-card h3{font-size:15px;line-height:1.55;color:#243b4a;margin:9px 0 6px;font-weight:800}.home-community-card p{font-size:10px;line-height:1.8;color:#5f6c72;margin:0;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.home-community-meta{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:12px;padding-top:10px;border-top:1px solid #eceeeb;color:#758085;font-size:9px}.home-community-meta b{color:#5b746a;font-size:9px}.home-community-foot{display:flex;justify-content:space-between;align-items:center;gap:14px;margin-top:14px;border:1px solid #dfe2dd;border-radius:13px;background:#fff;padding:11px 13px;color:#687378;font-size:9px}.home-community-foot a{color:#3f6578;font-weight:900;white-space:nowrap}@media(max-width:800px){.home-community-preview{padding:34px 16px}.home-community-head{display:block}.home-community-more{margin-top:13px}.home-community-grid{grid-template-columns:1fr}.home-community-foot{display:block}.home-community-foot a{display:block;margin-top:6px}}';
...
(function(){
  ...
  if(brand){brand.innerHTML='<div class="anotoki-header-brand"><strong>アノトキ</strong><small>医療・介護の選択を、経験から考える。</small></div>';var style=document.createElement('style');style.textContent='.site-header .brand{gap:0}.anotoki-header-brand{display:flex;flex-direction:column;justify-content:center;min-width:180px;line-height:1.05}.anotoki-header-brand strong{font-family:"Yu Mincho","Hiragino Mincho ProN",serif;font-size:22px;letter-spacing:.14em;font-weight:700;color:#087e8b}.anotoki-header-brand strong:after{content:"♥";margin-left:5px;font-size:10px;color:#ef8f88;vertical-align:middle}.anotoki-header-brand small{margin-top:5px;font-size:7px;letter-spacing:.08em;color:#6f8192}@media(max-width:700px){.anotoki-header-brand{min-width:155px}.anotoki-header-brand strong{font-size:20px}.anotoki-header-brand small{font-size:6px}}';document.head.appendChild(style);}
  var footerBrand=document.querySelector('.foot-brand');if(footerBrand){footerBrand.innerHTML='アノトキ <small style="display:block;font:7px Georgia,serif;letter-spacing:.25em;color:#8b98a2">ANOTOKI</small>';}
  var copy=document.querySelector('.copy');if(copy){var visitor=copy.querySelector('.visitor-count');copy.innerHTML='';if(visitor)copy.appendChild(visitor);copy.appendChild(document.createTextNode('© 2026 Anotoki'));}
  var description=document.querySelector('meta[name="description"]');if(description){description.setAttribute('content','アノトキは、医療・介護の選択を経験から考えるための情報サイトです。まず価値観を整理し、その選択の先にある暮らし、みんなの体験、専門情報へつなぎます。');}
})();